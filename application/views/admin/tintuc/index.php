                        ...
                        <tr class="filter">
                                ...
                                <select id="news_group" name="news_group">
                                    ...
                                    <?php if (!empty($news_group)) : ?>
                                        <?php foreach ($news_group as $kqnews_group) : ?>
                                            <option value="<?= $kqnews_group->id; ?>" <?php if (@$_news_group == $kqnews_group->id) echo "selected"; ?>><?php if($kqnews_group->parent!=0) echo "---";?><?= $kqnews_group->name; ?></option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                            </td>
                            ...
                            <td>
                                <select id="status" name="status">
                                    ...
                                    <option value="1" <?php if ($_status == 1) {
                                        echo "selected";
                                    } ?>>Enbale</option>

                                    <option value="0" <?php if ($_status == 0) {
                                        echo "selected";
                                    }; ?>>Disable</option>
    ...
    <?php foreach ($lists as $user) : ?>
                                <tr>
                                    ...
                                    <td class="left"  style="width: 10%;"><?
                                        ...
                                        $sql="select * from cat_new where id=\"".$idgroupnew."\"";	
...
<script type="text/javascript">
    ...
    function do_search() {
        ...
        url = url + '?title=' + _title + '&des=' + _des + '&news_group=' + _news_group + '&status=' + _status;
