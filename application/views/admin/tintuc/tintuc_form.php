                                        ...
                                        <?php if (!empty($cat)) : ?>
                                            <?php foreach ($cat as $c) : ?>
                                                <?php if (@$article->id_group_new != '') : ?>
                                                    ...
                                                    <option value="<?= $c->id; ?>" <?php if (@$article->id_group_new == $c->id) echo "selected"; ?>><?php if($c->parent!=0) echo "---";?><?= $c->name; ?></option>
                                                <?php else : ?>
                                                    <option value="<?= $c->id; ?>" <?php echo set_select('cat', $c->id); ?>><?php if($c->parent!=0) echo "---";?><?= $c->name; ?></option>
                                                <?php endif; ?>
...
<?= form_error('detail'); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="display" <?php if (@$article->display == 1) echo "checked=checked";
else ""; ?>/>
<?= form_error('display'); ?>
                                </td>
                            </tr>
