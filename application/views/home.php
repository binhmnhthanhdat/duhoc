...
<div class="boxContact marT20">
   <div class="flLeft fone">
      ...
      <div class="flLeft hotline hotlinefirst" style="margin-top:40px;">
         <p class="fontsize15 padT40 bold" style="color: #0e75b9; font-size:15px;">BẢO TRÌ MÁY TÍNH</p>
         <p class="colorRed fontsize18 padT3">0935351313</p>
         <p class="colorRed fontsize18 padT3">024.66616333</p>
      </div>      
      <div class="flLeft hotline"  style="margin-top:40px;">
         <p class="fontsize15 padT40 bold" style="color: #0e75b9; font-size:15px;">THI CÔNG MẠNG LAN</p>
         <p class="colorRed fontsize18 padT3">0935351313</p>
         <p class="colorRed fontsize18 padT3">024.66616333</p>                 
      </div>
   </div>
   <div class="anhlienhe"><img src="<?echo base_url(); ?>images/project/lien-he-mang-lan.png" alt="lien-he-mang-lan" width="150px" height="175px;"/></div>
   <div class="clearFix"></div>
</div>
...
foreach ($layboxtext->result() as $kqlayboxtext) {
        ...
        ?>
   <div class="ghichu"><img  title="hop-tac-mang-lan" alt="hop-tac-mang-lan" src=" <?php echo base_url(); ?>images/news/hop-tac-mang-lan.png" style="float: left;" /><?php echo $kqlayboxtext->title; ?></div>
