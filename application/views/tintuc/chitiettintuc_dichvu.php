        ...
        if ($laygrouptintuc->num_rows() > 0) {
            ...
            if ($chitiettintuc->num_rows() > 0) {
                ...
                <div class="breadcrumb">
                    <h2 style = "display:inline"><a class = "bread" href="<?php echo base_url(); ?>">Thi công mạng LAN văn phòng</a></h2>
    ...
    <div class="ContentMain ">
        <div class="fixTopContent"></div>
            ...
            <div class="fixTopContent3">
                ...
                <div class="tagNews">
                    <p class="flLeft"><span class="fontsize13">Thi công mạng:</span>
                        <?php
            ...
            ?>
                <div class="service_other_left">
                    <div class="service_other_left_title">Mạng LAN | Bảo trì máy tính:</div>
                    <?php
