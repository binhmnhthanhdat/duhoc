...
class Tintuc_model extends CI_Model {
    ...
    function add($data) {
        ...
        $this->db->set('modified', $currentDate);
...
//tinhienthi
    ...
    function get_all_news($select = null, $title = null, $des = null, $tag = null, $news_group = null, $project_group = null, $status = null, $where = null, $order = null, $limit = null) {
        ...
        if ($des != null)
            $this->db->like('description', $des);
        if ($tag != null)
            $this->db->like('tag', $tag);
        if ($news_group != null)
            $this->db->where('id_group_new', $news_group);
        if ($project_group != null)
            $this->db->where('id_group_project', $project_group);
        if ($status != null)
